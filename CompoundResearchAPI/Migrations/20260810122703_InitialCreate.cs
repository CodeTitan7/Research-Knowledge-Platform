        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", nullable: true),
                    MolecularFormula = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Compounds_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Compounds_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompoundTargets", x => new { x.CompoundId, x.TargetId });
                    table.ForeignKey(
                        name: "FK_CompoundTargets_Compounds_CompoundId",
                        column: x => x.CompoundId,
                        principalTable: "Compounds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompoundTargets_Targets_TargetId",
                        column: x => x.TargetId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedCompoundId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Documents_Compounds_RelatedCompoundId",
                        column: x => x.RelatedCompoundId,
                        principalTable: "Compounds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Compounds_CategoryId",
                table: "Compounds",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Compounds_CreatedById",
                table: "Compounds",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Compounds_Status",
                table: "Compounds",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_CompoundTargets_TargetId",
                table: "CompoundTargets",
                column: "TargetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_RelatedCompoundId",
                table: "Documents",
                column: "RelatedCompoundId");
